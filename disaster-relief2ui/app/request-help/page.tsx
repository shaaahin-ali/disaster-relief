          ...
          <div className="text-center space-y-6 pt-4">
            ...
            <div>
              ...
              <p className="text-text-secondary text-lg font-body max-w-xl mx-auto">
                Transmit your situation to the network. Nearby responders will
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label
                    htmlFor="title"
                    className="text-xs font-mono uppercase tracking-label text-text-secondary flex items-center gap-2"
                  >
                ...
                <div className="space-y-2">
                  <Label
                    ...
                    className="text-xs font-mono uppercase tracking-label text-text-secondary flex items-center gap-2"
                  >
                    <span className="text-accent-red">*</span> Detailed
                    Telemetry
                  </Label>
                  <Textarea
                    id="description"
                    ...
                    >
                      {photoPreview ? (
                        ...
                        <div className="text-center space-y-3">
                          ...
                          <div>
                            <p className="text-text-primary font-display font-medium">
                              Click to attach visual data
                            </p>
                            <p className="text-text-muted text-xs font-mono mt-1 uppercase tracking-widest">
                              PNG, JPG (MAX 5MB)
                            </p>
                          </div>
                        </div>
                ...
                <div className="pt-6 border-t border-glass-border">
                  <Button
                    ...
                    className={`w-full h-16 text-lg font-display font-black rounded-xl border-none tracking-wide transition-all ${
                      success
                        ? "bg-accent-teal text-bg-void"
                        : loading
                          ? "bg-glass-02 text-text-muted cursor-not-allowed border border-glass-border"

      ...
      <div className="relative z-10">
        ...
        >
          <nav className="px-8 flex items-center justify-between">
            <span className="text-lg font-black tracking-tight text-black">Sahay Kerala</span>
        ...
        <section className="min-h-screen flex items-center justify-center px-6 pt-20">
          <div className="flex flex-col items-center justify-center text-center w-full">
            ...
            >
              Kerala-focused disaster relief platform connecting people in need with compassionate volunteers.
              Built for God's Own Country with local emergency resources and community support.
            </p>
        ...
        <section className="min-h-screen flex items-center justify-center px-6 py-24 border-t border-black/10">
          <div className="max-w-6xl w-full">
            ...
            <p className="text-center text-black/50 mb-20 max-w-2xl mx-auto font-light text-lg">
              Kerala-focused disaster relief with local emergency resources
            </p>

            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  title: "Kerala Emergency SOS",
                  description: "Instant access to all Kerala police stations, fire services, and disaster management helplines",
                },
                {
                  title: "Local Community Network",
                  description: "Connect with verified volunteers across all 14 districts of Kerala",
                },
                {
                  title: "Disaster-Ready Platform",
                  description: "Built for Kerala with monsoon flooding, landslides, and emergency response protocols",
                },
              ].map((feature, i) => (
                <div
                  key={i}

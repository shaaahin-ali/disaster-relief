    ...
    <Dialog open={mode !== null} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md glass-card border flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5">
          {error && (
            <div className="p-4 rounded-lg bg-accent-red/10 border border-accent-red/20 text-sm text-accent-red">
              {error}
            </div>
          )}
          ...
          <div className="space-y-2 w-full">
            <Label
              htmlFor="email"
              className="text-text-primary font-semibold text-sm tracking-label uppercase"
            >
              Email
            </Label>
            <Input

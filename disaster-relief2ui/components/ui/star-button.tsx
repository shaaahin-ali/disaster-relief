...
export function StarButton({
  ...
  return (
    <button
      ...
      className={cn(
        "group/star-button relative z-[3] inline-flex h-11 items-center justify-center gap-2 overflow-hidden rounded-full px-5 py-2 text-sm font-semibold text-white transition-transform duration-200 hover:-translate-y-0.5 disabled:opacity-50",
        className,
      )}
      {...props}
    >
      <div
        className="absolute inset-0 aspect-square animate-star-btn bg-[radial-gradient(ellipse_at_center,var(--light-color),transparent,transparent)] opacity-80"
        style={
          {
            offsetPath: "var(--path)",
            offsetDistance: "0%",
      ...
      />
      <div
        className="absolute inset-0 z-[4] overflow-hidden rounded-[inherit] text-white"
        style={{
      ...
      <span className="relative z-10 bg-gradient-to-t from-white to-neutral-300 bg-clip-text text-transparent">
        {children}
      </span>
    </button>
  );
